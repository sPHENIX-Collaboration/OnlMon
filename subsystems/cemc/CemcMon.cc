...
int CemcMon::process_event(Event *e /* evt */)
{
  ...
  if (anaGL1)
  {
    ...
    //use MBD>=2 for AuAu
    if(usembdtrig){
      if(trig_bools.at(TriggerEnum::BitCodes::MBD_NS2_ZVRTX10) == 0 && trig_bools.at(TriggerEnum::BitCodes::MBD_NS2_ZVRTX30) == 0 && trig_bools.at(TriggerEnum::BitCodes::MBD_NS2_ZVRTX150) == 0 && trig_bools.at(TriggerEnum::BitCodes::MBD_NS2) == 0){
        fillhist = false;
      }
    }
