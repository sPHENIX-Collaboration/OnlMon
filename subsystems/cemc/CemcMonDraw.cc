...
int CemcMonDraw::Init()
{
  ...
  else
  {
    ...
    std::string Templatefilename = std::string(CEMCcalib) + "/" + "Template_82400_50ADC_hits.root";
    ...
    std::string Templatefilename_alltrig = std::string(CEMCcalib) + "/" + "Template_82400_50ADC_alltrig.root";
